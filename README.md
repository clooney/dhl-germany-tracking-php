# Deutsche Post DHL Tracking API For PHP
Deutsche Post DHL Tracking API and webhook make it easy to integrate Deutsche Post DHL Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Deutsche Post DHL Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Deutsche Post DHL Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Deutsche Post DHL Tracking API](https://www.trackingmore.com/dhl-germany-tracking.html)  to:

   *   Get Deutsche Post DHL realtime tracking info of muti-carriers in one integration
   *   Provide Deutsche Post DHL shipment tracking experience like Amazon
   *   Push Deutsche Post DHL notifications of package update with webhook
   *   Verify Deutsche Post DHL delivery exception before it is too late
